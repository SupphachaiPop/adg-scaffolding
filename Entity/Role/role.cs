...
{ 
    public class role
    {
        ...
        public virtual ICollection<role_menu> role_menu { get; set; } // role_menu.fk_role_menu_role_role_id
        public virtual ICollection<user> user { get; set; } // user.fk_user_role_role_id
        public role()
        {
