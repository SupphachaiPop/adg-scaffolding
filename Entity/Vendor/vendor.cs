...
namespace Entity
{
    public class vendor
    {
        ...
        public virtual ICollection<purchase_request> purchase_request { get; set; } // purchase_request.FK_purchase_request_vendor
        public vendor()
        {
            this.purchase_request = new List<purchase_request>();
        }
    }
}
