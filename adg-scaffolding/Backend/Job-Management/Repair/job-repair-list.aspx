<%@ Page Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="job-repair-list.aspx.cs" Inherits="adg_scaffolding.Backend.Job_Management.Repair.job_repair_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FromPlaceHolder" runat="server">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="card-body">
                                <div class="card-datatable table-responsive">
                                    <table id="tblJobRepair" class="table table-hover table-bordered">
    ...
    <script src="/assets/js/JobManagement/job-repair-list.js"></script>
