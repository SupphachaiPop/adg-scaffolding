<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="job-delivery-info.aspx.cs" Inherits="adg_scaffolding.Backend.Job_Management.Delivery.job_delivery_info" %>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label form-label-sm text-uppercase">
                                            <asp:LinkButton ID="btnCreateJobDelivery" CssClass="btn btn-success mt-4" OnClick="btnCreateJobDelivery_Click" runat="server"> <span class="ion ion-md-add mr-1"></span> ADD</asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-datatable table-responsive">
                                    <table class="datatables-demo table table-striped table-hover table-bordered">
                                        ...
                                        <tbody>
                                            <asp:Repeater ID="rptJobDelivery" runat="server" OnItemDataBound="rptJobDelivery_ItemDataBound" OnItemCommand="rptJobDelivery_ItemDataBound">
                                                <ItemTemplate>
                                                    <tr class="odd gradeX">
                                                        <td>
