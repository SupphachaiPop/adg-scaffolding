<%@ Page Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="user-list.aspx.cs" Inherits="adg_scaffolding.Backend.Administrator.User.user_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FromPlaceHolder" runat="server">
    ...
    <script src="/assets/js/administration/User-list.js"></script>
