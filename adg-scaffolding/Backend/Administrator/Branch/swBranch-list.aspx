<%@ Page Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="swBranch-list.aspx.cs" Inherits="adg_scaffolding.Backend.Administrator.Branch.swBranch_list" %>
        ...
        <ContentTemplate>
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <h4 class="font-weight-bold py-3 mb-2">BRANCH
                    ...
                    <br />
                    <asp:LinkButton ID="btnCreateBranch" CssClass="btn btn-round  btn-success btn-sm mr-2" OnClick="btnCreateBranch_Click" runat="server">
