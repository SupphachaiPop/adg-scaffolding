<%@ Page Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="company-list.aspx.cs" Inherits="adg_scaffolding.Backend.Administrator.Company.company_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FromPlaceHolder" runat="server">
        ...
        <ContentTemplate>
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <h4 class="font-weight-bold py-3 mb-2">COMPANY
                    ...
                    <br />
                    <asp:LinkButton ID="btnCreateCompany" CssClass="btn btn-round  btn-success btn-sm mr-2" OnClick="btnCreateCompany_Click" runat="server">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="card-body">
                                <div class="card-datatable table-responsive">
                                    <table id="tblCompany" class="table table-hover table-bordered">
    ...
    <script src="/assets/js/administration/company-list.js"></script>
</asp:Content>
