<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="company-info.aspx.cs" Inherits="adg_scaffolding.Backend.Administrator.Company.company_info" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <h4 class="font-weight-bold py-3 mb-2">COMPANY
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                                ...
                                                <span class="text-danger">*</span>
                                                    ...
                                                    <asp:TextBox ID="txtCompanyCode" CssClass="form-control form-control-md" runat="server" placeholder="Company Code"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-xl-4 mb-4 col-sm-12" id="DropdownCompanyType" runat="server">
                                                <div class="form-group">
                                                    <label class="form-label form-label-sm text-uppercase">
                                                        Company Type
                                                <span class="text-danger">*</span>
                                                    </label>
                                                    <asp:DropDownList ID="ddlCompanyType" CssClass="form-control form-control-md text-uppercase  js-example-basic-single" runat="server">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                                ...
                                                <span class="text-danger">*</span>
                                                    ...
                                                    <asp:TextBox ID="txtCompanyName" CssClass="form-control form-control-md" runat="server" placeholder="Company Name"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                                <div class="form-group">
                                                ...
                                                <span class="text-danger">*</span>
                                                    ...
                                                    <asp:TextBox ID="txtTax" CssClass="form-control form-control-md" runat="server" placeholder="Tax No"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="tab-pane fade" id="feature" role="tabpanel" aria-labelledby="feature-tab">
                                        ...
                                        <div class="card-datatable table-responsive">
                                            <table class="datatables-demo table table-striped table-hover table-bordered">
                                                ...
                                                <tbody>
                                                    <asp:Repeater ID="rptCompanyMenu" runat="server" OnItemDataBound="rptCompanyMenu_ItemDataBound">
                                                        <ItemTemplate>
                                                            <tr class="odd gradeX">
                                                                <td>
                                                                    <asp:Label ID="lblCompanyMenuId" Visible="false" runat="server"></asp:Label>
