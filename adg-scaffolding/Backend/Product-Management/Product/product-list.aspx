<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="product-list.aspx.cs" Inherits="adg_scaffolding.Backend.Product_Management.Product.product_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FromPlaceHolder" runat="server">
        ...
        <ContentTemplate>
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <h4 class="font-weight-bold py-3 mb-2">PRODUCT
                     ...
                     <asp:LinkButton ID="btnCreateProduct" CssClass="btn btn-success mt-4" OnClick="btnCreateProduct_Click" runat="server">
    ...
    <script src="/assets/js/productManagement/product-list.js"></script>
</asp:Content>
