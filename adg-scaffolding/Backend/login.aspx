...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white">
        <div class="container">
            <a href="javascript:void(0);" class="navbar-brand text-large font-weight-bolder line-height-1 py-2">
                <i class="ion ion-md-trending mr-2"></i>Coverage Service
            </a>
    ...
    <nav class="footer bg-white">
        <div class="container text-center py-3">
            <div class="pb-3">
                <a href="javascript:void(0)" class="footer-text font-weight-bolder">Coverage Service</a> &copy; &nbsp;All rights reserved
            </div>
        </div>
    </nav>
    <!-- / Footer -->
