<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="location-info.aspx.cs" Inherits="adg_scaffolding.Backend.Warehouse_Management.Location.location_info" %>
                    ...
                    <div class="row no-gutters row-bordered">
                        <div class="col-md-12 col-lg-12 col-xl-12">
                            <div class="card-body">
                                ...
                                <hr class="mb-3">
                                <div class="row">
                                    <div class="col-lg-4 col-xl-4 mb-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtLocationCode" CssClass="form-control form-control-md" runat="server" placeholder="Location Code"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtLocationName" CssClass="form-control form-control-md" runat="server" placeholder="Location Name"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <table class="datatables-demo table table-striped table-hover table-bordered">
                                        <thead class="thead-dark">
                                            <tr>
                                                ...
                                                <th class="tbw-10">Zone Code</th>
                                                <th class="tbw-10">Zone Name</th>
                                        ...
                                        <tbody>
                                            <asp:Repeater ID="rptZone" runat="server" OnItemDataBound="rptZone_ItemDataBound" OnItemCommand="rptZone_ItemDataBound">
                                                <ItemTemplate>
                                                    <tr class="odd gradeX">
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblZoneId" Visible="false" runat="server"></asp:Label>
                                                            <asp:TextBox ID="txtZoneCode" CssClass="form-control form-control-md" runat="server" placeholder="Zone Code"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtZoneName" CssClass="form-control form-control-md" runat="server" placeholder="Zone Name"></asp:TextBox>
                                                        </td>
                                                        <td>
