<%@ Page Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="location-list.aspx.cs" Inherits="adg_scaffolding.Backend.Warehouse_Management.Location.location_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FromPlaceHolder" runat="server">
        ...
        <ContentTemplate>
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <h4 class="font-weight-bold py-3 mb-2">LOCATION
                    ...
                    <asp:LinkButton ID="btnCreateLocation" CssClass="btn btn-success mt-4" OnClick="btnCreateLocation_Click" runat="server">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="card-body">
                                <div class="card-datatable table-responsive">
                                    <table id="tblLocation" class="table table-hover table-bordered">
    ...
    <script src="/assets/js/warehouseManagement/location-list.js"></script>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ModalPlaceHolder" runat="server">
    ...
    <div class="modal fade" id="DeleteRecord" tabindex="-1" location="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-dialog-centered" location="document">
    ...
    <div class="modal fade" id="ModalSuccess" tabindex="-1" location="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-dialog-centered" location="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="ModalFail" tabindex="-1" location="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-dialog-centered" location="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="ModalError" tabindex="-1" location="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-dialog-centered" location="document">
            <div class="modal-content">
                <div class="modal-header">
