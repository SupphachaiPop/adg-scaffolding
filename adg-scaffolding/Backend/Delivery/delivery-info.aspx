<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="delivery-info.aspx.cs" Inherits="adg_scaffolding.Backend.Delivery.delivery_info" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <contenttemplate>
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <h4 class="font-weight-bold py-3 mb-2">DELIVERY
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="lblDeliveryId" runat="server" Visible="false"></asp:Label>
                                            <asp:TextBox ID="txtDeliveryCode" CssClass="form-control form-control-md" runat="server" placeholder="Delivery Code"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtDeliveryName" CssClass="form-control form-control-md" runat="server" placeholder="Delivery Name"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
