<%@ Page Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="store-curculation-list.aspx.cs" Inherits="adg_scaffolding.Backend.Store.Store_Curculation.store_curculation_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FromPlaceHolder" runat="server">
        ...
        <ContentTemplate>
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <h4 class="font-weight-bold py-3 mb-2">STORE CURCULATION
                    ...
                    <asp:LinkButton ID="btnCreateStoreCurculation" CssClass="btn btn-success mt-4" OnClick="btnCreateStoreCurculation_Click" runat="server">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="card-body">
                                <div class="card-datatable table-responsive">
                                    <table id="tblStoreCurculation" class="table table-hover table-bordered">
                                        <thead class="thead-dark">
                                            <tr>
                                                <th>Curculation No</th>
                                                <th>Loaner Date</th>
                                                <th>Loaner Name</th>
                                                <th>Return Date</th>
                                                <th>Return Name</th>
    ...
    <script src="/assets/js/store/store-curculation-list.js"></script>
</asp:Content>
