<%@ Page Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="product-store-list.aspx.cs" Inherits="adg_scaffolding.Backend.Store.Product_Store.product_store_list" %>
        ...
        <contenttemplate>
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <h4 class="font-weight-bold py-3 mb-2">PRODUCT STORE
                    ...
                    <asp:LinkButton ID="btnCreateProductStore" CssClass="btn btn-success mt-4" OnClick="btnCreateProductStore_Click" runat="server">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="card-body">
                                <div class="card-datatable table-responsive">
                                    <table id="tblProductStore" class="table table-hover table-bordered">
