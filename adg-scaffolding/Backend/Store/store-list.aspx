<%@ Page Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="store-list.aspx.cs" Inherits="adg_scaffolding.Backend.Store.store_list" %>
        ...
        <ContentTemplate>
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <h4 class="font-weight-bold py-3 mb-2">STORE
                    ...
                    <asp:LinkButton ID="btnCreateStore" CssClass="btn btn-success mt-4" OnClick="btnCreateStore_Click" runat="server">
