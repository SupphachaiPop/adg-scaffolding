<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-tax-invoice.aspx.cs" Inherits="adg_scaffolding.Backend.Print.print_tax_invoice" %>
                                            ...
                                            <div class="container">
                                                <div class="row mb-2 ">
                                                    <div class="col-sm-2 col-lg-2 col-xl-2 mb-1">
                                                        ...
                                                        <asp:HiddenField ID="hddftaxInvoiceID" runat="server" />
                                                    ...
                                                    <div class="col-sm-8 col-lg-8 col-xl-8 mb-2 text-right">
                                                        <span class="badge p-2 ">
                                                            <h5 class="mb-0">ต้นฉบับใบกำกับภาษี/ใบเสร็จรับเงิน</h5>
                                                            <br />
                                                            <h5 class="mb-0">Orginal Tax Invoice/Receive</h5>
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row bd-grey mb-3 p-2 ">
                                                    ...
                                                    <div class="col-sm-6 col-lg-6 col-xl-6 bd-l-dark">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 col-lg-6 col-xl-6 ">
                                                                <div class="pt-2">
                                                                    <asp:Label ID="txttaxInvoiceDate" runat="server" CssClass=""></asp:Label>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 col-lg-6 col-xl-6 ">
                                                                <div class="pt-2">
                                                                    <asp:Label ID="txttaxInvoiceNo" runat="server" CssClass=""></asp:Label>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 col-lg-6 col-xl-6 ">
                                                                <div class="pt-2">
                                                                    <asp:Label ID="txttaxInvoiceCustomer" runat="server" CssClass=""></asp:Label>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6 col-lg-6 col-xl-6 text-right">
                                                                ...
                                                                <div class="pt-2">
                                                                    <strong>taxInvoice valid until :</strong>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6 col-lg-6 col-xl-6 ">
                                                                <div class="pt-2">
                                                                    <asp:Label ID="txttaxInvoiceValid" runat="server" CssClass=""></asp:Label>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 col-lg-6 col-xl-6 ">
                                                                <div class="pt-2">
                                                                    <asp:Label ID="txttaxInvoicePrepared" runat="server" CssClass=""></asp:Label>
                                                                </div>
