<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-purchase-request.aspx.cs" Inherits="adg_scaffolding.Backend.Print.print_purchase_request" %>
                                            ...
                                            <div class="container">
                                                <div class="row mb-2 ">
                                                    ...
                                                    <div class="col-sm-8 col-lg-8 col-xl-8 mb-2 text-right">
                                                        <span class="badge p-2 ">
                                                            <h5 class="mb-0">ใบขอจัดซื้อ / จัดจ้าง</h5>
                                                            <br />
