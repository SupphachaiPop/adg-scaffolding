<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-purchase-order.aspx.cs" Inherits="adg_scaffolding.print_purchase_order" %>
                                            ...
                                            <div class="container">
                                                <div class="row mb-2 ">
                                                    <div class="col-sm-2 col-lg-2 col-xl-2 mb-1">
                                                        ...
                                                        <asp:HiddenField ID="hddfpurchaseOrderID" runat="server" />
                                                    ...
                                                    <div class="col-sm-8 col-lg-8 col-xl-8 mb-2 text-right">
                                                        <span class="badge p-2 ">
                                                            <h5 class="mb-0">ใบจัดซื้อ / จัดจ้าง</h5>
                                                            <br />
                                                ...
                                                <div class="row bd-grey mb-3 p-2 ">
                                                    <div class="col-sm-6 col-lg-6 col-xl-6 ">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6 col-lg-6 col-xl-6">
                                                                <div class="pt-2">
                                                                    <strong>purchaseOrder For</strong>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6 col-lg-6 col-xl-6 ">
                                                                <div class="pt-2">
                                                    ...
                                                    <div class="col-sm-6 col-lg-6 col-xl-6 bd-l-dark">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 col-lg-6 col-xl-6 ">
                                                                <div class="pt-2">
                                                                    <asp:Label ID="txtpurchaseOrderDate" runat="server" CssClass=""></asp:Label>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 col-lg-6 col-xl-6 ">
                                                                <div class="pt-2">
                                                                    <asp:Label ID="txtpurchaseOrderNo" runat="server" CssClass=""></asp:Label>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 col-lg-6 col-xl-6 ">
                                                                <div class="pt-2">
                                                                    <asp:Label ID="txtpurchaseOrderCustomer" runat="server" CssClass=""></asp:Label>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6 col-lg-6 col-xl-6 text-right">
                                                                ...
                                                                <div class="pt-2">
                                                                    <strong>purchaseOrder valid until :</strong>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6 col-lg-6 col-xl-6 ">
                                                                <div class="pt-2">
                                                                    <asp:Label ID="txtpurchaseOrderValid" runat="server" CssClass=""></asp:Label>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 col-lg-6 col-xl-6 ">
                                                                <div class="pt-2">
                                                                    <asp:Label ID="txtpurchaseOrderPrepared" runat="server" CssClass=""></asp:Label>
                                                                </div>
