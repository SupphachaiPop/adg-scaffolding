<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="category-list.aspx.cs" Inherits="adg_scaffolding.Backend.MasterData.category_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FromPlaceHolder" runat="server">
        ...
        <ContentTemplate>
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <h4 class="font-weight-bold py-3 mb-2">BRANCH
                    ...
                    <br />
                    <asp:LinkButton ID="btnCreateCategory" CssClass="btn btn-round  btn-success btn-sm mr-2" OnClick="btnCreateCategory_Click" runat="server">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="card-body">
                                <div class="card-datatable table-responsive">
                                    <table id="tblBranch" class="table table-hover table-bordered">
    ...
    <script src="/assets/js/administration/branch-list.js"></script>
</asp:Content>
