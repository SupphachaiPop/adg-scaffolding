var urlList = "/Backend/Job-Management/Cleaning/job-cleaning-list.aspx";
var urlInfo = "/Backend/Job-Management/Cleaning/job-cleaning-info.aspx";
var msg;
var tblId = '#tblJobCleaning';
var tblObj;
...
$(function () {
    ...
    function renderCol_Tools(data, type, row, meta) {
        ...
        if (type === 'display') {
            ...
            ret += '<div class="btn-group btn-group-sm">' + aView;
            ret += '</div>';
