...
<asp:Content ID="Content2" ContentPlaceHolderID="FromPlaceHolder" runat="server">
        ...
        <ContentTemplate>
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <h4 class="font-weight-bold py-3 mb-2">CUSTOMER
                    ...
                    <asp:LinkButton ID="btnCreateCustomer" CssClass="btn btn-success mt-4" OnClick="btnCreateCustomer_Click" runat="server">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="card-body">
                                <div class="card-datatable table-responsive">
                                    <table id="tblCustomer" class="table table-hover table-bordered">
    ...
    <script src="/assets/js/customer/customer-list1.js"></script>
