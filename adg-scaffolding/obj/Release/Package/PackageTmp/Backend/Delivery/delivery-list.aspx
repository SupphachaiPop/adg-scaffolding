<%@ Page Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="delivery-list.aspx.cs" Inherits="adg_scaffolding.Backend.Delivery.delivery_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FromPlaceHolder" runat="server">
        ...
        <ContentTemplate>
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <h4 class="font-weight-bold py-3 mb-2">DELIVERY
                    ...
                    <asp:LinkButton ID="btnCreateDelivery" CssClass="btn btn-success mt-4" OnClick="btnCreateDelivery_Click" runat="server">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="card-body">
                                <div class="card-datatable table-responsive">
                                    <table id="tblDelivery" class="table table-hover table-bordered">
    ...
    <script src="/assets/js/delivery/delivery-list.js"></script>
