<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="specification-list.aspx.cs" Inherits="adg_scaffolding.Backend.Product_Management.Specification.specification_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FromPlaceHolder" runat="server">
        ...
        <ContentTemplate>
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <h4 class="font-weight-bold py-3 mb-2">SPECIFICATION
                     ...
                     <asp:LinkButton ID="btnCreateUser" CssClass="btn btn-success mt-4" OnClick="btnCreatespecification_Click" runat="server">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="card-body">
                                <div class="card-datatable table-responsive">
                                    <table id="tblSpecification" class="table table-hover table-bordered">
                                        <thead class="thead-dark">
                                            <tr>
                                                ...
                                                <th style="text-align:center; width:10%">Tools</th>
                                            </tr>
                                        </thead>
                                        <tbody>
    ...
    <script src="/assets/js/productManagement/specification-list.js"></script>
</asp:Content>
