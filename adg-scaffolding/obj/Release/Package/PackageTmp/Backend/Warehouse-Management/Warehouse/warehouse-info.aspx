<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="warehouse-info.aspx.cs" Inherits="adg_scaffolding.Backend.Warehouse_Management.Warehouse.warehouse_info" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <h4 class="font-weight-bold py-3 mb-2">WAREHOUSE
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtWarehouseCode" CssClass="form-control form-control-md" runat="server" placeholder="Warehouse Code"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtWarehouseName" CssClass="form-control form-control-md" runat="server" placeholder="Warehouse Name"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtAddress" CssClass="form-control form-control-md" TextMode="MultiLine" Rows="3" runat="server" placeholder="Comment"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
