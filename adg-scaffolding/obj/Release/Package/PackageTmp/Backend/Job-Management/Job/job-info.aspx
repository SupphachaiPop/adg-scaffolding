<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/MasterPage.Master" AutoEventWireup="true" CodeBehind="job-info.aspx.cs" Inherits="adg_scaffolding.Backend.Job_Management.Job.job_info" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <h4 class="font-weight-bold py-3 mb-2">JOB 
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label form-label-sm text-uppercase">
                                            <asp:LinkButton ID="btnCreateJob" CssClass="btn btn-success mt-4" OnClick="btnCreateJob_Click" runat="server"> <span class="ion ion-md-add mr-1"></span> ADD</asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-datatable table-responsive">
                                    <table class="datatables-demo table table-striped table-hover table-bordered">
                                        ...
                                        <tbody>
                                            <asp:Repeater ID="rptJob" runat="server" OnItemDataBound="rptJob_ItemDataBound" OnItemCommand="rptJob_ItemDataBound">
                                                <ItemTemplate>
                                                    <tr class="odd gradeX">
                                                        <td>
