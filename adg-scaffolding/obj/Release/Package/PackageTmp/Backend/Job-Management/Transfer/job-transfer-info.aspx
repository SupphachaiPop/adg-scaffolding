                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlLocationSource" CssClass="form-control form-control-sm text-uppercase  js-example-basic-single" OnSelectedIndexChanged="ddlLocationSource_SelectedIndexChanged" AutoPostBack="true" runat="server">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlZoneSource" CssClass="form-control form-control-sm text-uppercase  js-example-basic-single" OnSelectedIndexChanged="ddlZoneSource_SelectedIndexChanged" AutoPostBack="true" runat="server">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlLocationDestination" CssClass="form-control form-control-sm text-uppercase  js-example-basic-single" OnSelectedIndexChanged="ddlLocationDestination_SelectedIndexChanged" AutoPostBack="true" runat="server">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                    ...
                                    <div  class="col-lg-4 col-xl-4 mb-4 col-sm-12" >
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlStatusJob" CssClass="form-control form-control-sm text-uppercase  js-example-basic-single" runat="server">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlProductJob" CssClass="form-control form-control-sm text-uppercase  js-example-basic-single" OnSelectedIndexChanged="ddlProductJob_SelectedIndexChanged" AutoPostBack="true" runat="server">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-xl-4 mb-4 col-sm-12">
