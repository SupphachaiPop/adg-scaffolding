var urlList = "/Backend/Administrator/Company/company-list.aspx";
var urlInfo = "/Backend/Administrator/Company/company-info.aspx";
var msg;
var tblId = '#tblCompany';
var tblObj;
...
$(function () {
    ...
    tblObj = $(tblId).DataTable({
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    if (type === 'display') {
                        ...
                        return '<label class="switcher switcher-sm" ><input id="chkStatus" ' + disabled +' type="checkbox" ' + (data ? "checked" : "") + ' class="switcher-input" value="' + row.company_encrypt + '"><span class="switcher-indicator"><span class="switcher-yes"><span class="ion ion-md-checkmark"></span></span><span class="switcher-no"><span class="ion ion-md-close"></span></span></span></label>';
                    }
            ...
            {
                data: "company_encrypt", className: "text-center", orderable: false,
    ...
    function renderCol_Tools(data, type, row, meta) {
        ...
        var ret = '';
        var btnDelete = '<button type="button" id="btnDelete" ' + disabled +' rIndex="' + meta.row + '" class="btn btn-danger text-uppercase"><i class="ion ion-md-close"></i></button>';
    ...
    $(tblId + ' tbody').on('click', 'td button', function () {
        ...
        var company = tblObj.rows(rowIndex).data()[0];
        $("input[id*=hdfId]").val(company.company_encrypt);
