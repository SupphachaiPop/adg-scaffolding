var urlList = "/Backend/Administrator/Branch/swBranch-list.aspx";
var urlInfo = "/Backend/Administrator/Branch/swBranch-info.aspx";
var msg;
var tblId = '#tblBranch';
var tblObj;
...
$(function () {
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    if (type === 'display') {
                        return '<label class="switcher switcher-sm"><input id="chkStatus" type="checkbox" ' + (data ? "checked" : "") + ' class="switcher-input" value="' + row.branch_encrypt + '"><span class="switcher-indicator"><span class="switcher-yes"><span class="ion ion-md-checkmark"></span></span><span class="switcher-no"><span class="ion ion-md-close"></span></span></span></label>';
                    }
            ...
            {
                data: "branch_encrypt", className: "text-center", orderable: false,
    ...
    $(tblId + ' tbody').on('click', 'td button', function () {
        ...
        var branch = tblObj.rows(rowIndex).data()[0];

        $("input[id*=hdfId]").val(branch.branch_encrypt);
