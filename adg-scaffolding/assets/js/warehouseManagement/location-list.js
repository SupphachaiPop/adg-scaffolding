var urlList = "/Backend/Warehouse-Management/Location/location-list.aspx";
var urlInfo = "/Backend/Warehouse-Management/Location/location-info.aspx";
var msg;
var tblId = '#tblLocation';
var tblObj;
    ...
    tblObj = $(tblId).DataTable({
        ...
        ajax: {
            ...
            data: function (d) {
                ...
                d.warehouse_id = $("select[id*=ddlWarehouse]").find(':selected').val();
