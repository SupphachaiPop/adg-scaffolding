...
$(function() {
  ...
  $('#datepicker-base-4').datepicker({
    orientation: isRtl ? 'auto right' : 'auto left'
  });
  $('#datepicker-base-5').datepicker({
    orientation: isRtl ? 'auto right' : 'auto left'
  });
  $('#datepicker-base-6').datepicker({
    orientation: isRtl ? 'auto right' : 'auto left'
  });
  $('#datepicker-base-7').datepicker({
    orientation: isRtl ? 'auto right' : 'auto left'
  });
  $('#datepicker-base-8').datepicker({
    orientation: isRtl ? 'auto right' : 'auto left'
  });
  $('#datepicker-base-9').datepicker({
    orientation: isRtl ? 'auto right' : 'auto left'
  });
