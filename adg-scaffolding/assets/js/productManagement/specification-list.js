var urlList = "/Backend/Product-Management/Specification/specification-list.aspx";
var urlInfo = "/Backend/Product-Management/Specification/specification-info.aspx";
var msg;
var tblId = '#tblSpecification';
var tblObj;
...
$(function () {
    ...
    $(tblId + ' tbody').on('click', 'td button', function () {
        ...
        var specification = tblObj.rows(rowIndex).data()[0];
        $("input[id*=hdfId]").val(specification.id);
